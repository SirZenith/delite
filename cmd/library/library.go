...
import (
	...
	"github.com/SirZenith/delite/cmd/library/internal/tag"
...
func updateDefaultValue(info *book_mgr.LibraryInfo) {
	...
	info.MarkdownDirName = common.GetStrOr(info.MarkdownDirName, "markdown")
	info.PdfDirName = common.GetStrOr(info.PdfDirName, "pdf")
	info.TypstDirName = common.GetStrOr(info.TypstDirName, "typst")
